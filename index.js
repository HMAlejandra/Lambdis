...
const dbConfig = {
    // cambiar el host
    host: process.env.DB_HOST || 'database-3.carks02ue2k8.us-east-1.rds.amazonaws.com',
...
// Esto es crucial para mejorar el rendimiento y evitar problemas de agotamiento de conexiones en Lambda.
let pool;
// cloud computing!!!!
